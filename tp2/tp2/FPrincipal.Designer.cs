...
namespace tp2 {
	partial class FPrincipal {
		...
		private void InitializeComponent() {
			...
			this.mcReservas = new System.Windows.Forms.MonthCalendar();
			...
			// gbReservaNueva
			// 
			this.gbReservaNueva.Controls.Add(this.mcReservas);
			...
			// mc
			// 
			this.mcReservas.CalendarDimensions = new System.Drawing.Size(2, 1);
			this.mcReservas.Location = new System.Drawing.Point(13, 34);
			this.mcReservas.MaxSelectionCount = 14;
			this.mcReservas.MinDate = new System.DateTime(2023, 10, 16, 0, 0, 0, 0);
			this.mcReservas.Name = "mc";
			this.mcReservas.TabIndex = 0;
			// 
			// FPrincipal
			// 
			...
			this.MinimumSize = new System.Drawing.Size(420, 608);
