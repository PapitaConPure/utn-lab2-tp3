...
namespace tp2 {
	partial class FPrincipal {
		...
		private void InitializeComponent() {
			...
			this.tlpBotonesPropiedades.Controls.Add(this.btnVer, 1, 0);
			...
			this.tlpBotonesPropiedades.TabIndex = 11;
			// 
			// gbResidencias
			// 
			...
			this.gbResidencias.TabIndex = 12;
			...
			this.tableLayoutPanel1.Size = new System.Drawing.Size(740, 54);
			...
			this.tlpBotonesAgregar.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Percent, 45F));
			this.tlpBotonesAgregar.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Percent, 10F));
			this.tlpBotonesAgregar.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Percent, 45F));
			...
			this.tlpBotonesAgregar.Size = new System.Drawing.Size(740, 42);
			this.tlpBotonesAgregar.TabIndex = 15;
			// 
			// tlpBotonesDatos
			// 
			...
			this.lsbResidencias.TabIndex = 4;
			// 
			// label1
			// 
