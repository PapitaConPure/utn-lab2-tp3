...
namespace tp2
{
    partial class FPasajero
    {
        ...
        private void InitializeComponent()
        {
            ...
            0,
            0});
			this.nudDniPasajero.Click += new System.EventHandler(this.SeleccionarNumericUpDown);
			this.nudDniPasajero.Enter += new System.EventHandler(this.SeleccionarNumericUpDown);
			// 
			// tbNombrePasajero
			// 
			...
			this.tbNombrePasajero.Click += new System.EventHandler(this.SeleccionarTextBox);
			this.tbNombrePasajero.Enter += new System.EventHandler(this.SeleccionarTextBox);
			// 
			// btnAceptar
			// 
			...
			this.Shown += new System.EventHandler(this.FPasajero_Shown);
